...
export class PollResolverBase {
  ...
  async createPoll(@graphql.Args() args: CreatePollArgs): Promise<Poll> {
    return await this.service.createPoll({
      ...
      data: {
        ...
        pollOption: args.data.pollOption
          ? {
              connect: args.data.pollOption,
            }
          : undefined,
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => PollOption, {
    nullable: true,
    name: "pollOption",
  })
  @nestAccessControl.UseRoles({
  ...
  async getPollOption(
    ...
    const result = await this.service.getPollOption(parent.id);
  ...
  async getVoter(@graphql.Parent() parent: Poll): Promise<User | null> {
