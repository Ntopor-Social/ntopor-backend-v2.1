...
class PollingCreateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => PollOptionCreateNestedManyWithoutPollingsInput,
  })
  @ValidateNested()
  @Type(() => PollOptionCreateNestedManyWithoutPollingsInput)
  @IsOptional()
  @Field(() => PollOptionCreateNestedManyWithoutPollingsInput, {
    nullable: true,
  })
...
export { PollingCreateInput as PollingCreateInput };
