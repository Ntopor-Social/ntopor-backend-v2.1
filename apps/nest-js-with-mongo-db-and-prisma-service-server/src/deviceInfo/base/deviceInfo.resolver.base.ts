...
import { CreateDeviceInfoArgs } from "./CreateDeviceInfoArgs";
import { UpdateDeviceInfoArgs } from "./UpdateDeviceInfoArgs";
...
export class DeviceInfoResolverBase {
  ...
  async createDeviceInfo(
    @graphql.Args() args: CreateDeviceInfoArgs
  ): Promise<DeviceInfo> {
  ...
  async updateDeviceInfo(
    @graphql.Args() args: UpdateDeviceInfoArgs
  ): Promise<DeviceInfo | null> {
    try {
  ...
  async getUser(@graphql.Parent() parent: DeviceInfo): Promise<User | null> {
