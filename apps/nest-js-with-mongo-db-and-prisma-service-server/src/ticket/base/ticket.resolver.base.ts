...
export class TicketResolverBase {
  ...
  async createTicket(@graphql.Args() args: CreateTicketArgs): Promise<Ticket> {
    return await this.service.createTicket({
      ...
      data: {
        ...
        boughtBy: args.data.boughtBy
          ? {
              connect: args.data.boughtBy,
            }
          : undefined,
        ...
        ticketType: args.data.ticketType
          ? {
              connect: args.data.ticketType,
            }
          : undefined,
      },
    });
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => [User], { name: "ticketOwners" })
  @nestAccessControl.UseRoles({
    resource: "User",
    action: "read",
    possession: "any",
  ...
  async findTicketOwners(
    ...
    const results = await this.service.findTicketOwners(parent.id, args);
  ...
  async getBoughtBy(@graphql.Parent() parent: Ticket): Promise<User | null> {
    const result = await this.service.getBoughtBy(parent.id);
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => TicketPackage, {
    nullable: true,
    name: "ticketType",
  })
  @nestAccessControl.UseRoles({
  ...
  async getTicketType(
    ...
    const result = await this.service.getTicketType(parent.id);
