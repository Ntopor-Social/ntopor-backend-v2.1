...
class PollOptionUpdateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => PollUpdateManyWithoutPollOptionsInput,
  })
  @ValidateNested()
  @Type(() => PollUpdateManyWithoutPollOptionsInput)
  @IsOptional()
  @Field(() => PollUpdateManyWithoutPollOptionsInput, {
    nullable: true,
  })
  polls?: PollUpdateManyWithoutPollOptionsInput;
}

export { PollOptionUpdateInput as PollOptionUpdateInput };
