...
@InputType()
class VoteEventCandidateUpdateInput {
  @ApiProperty({
    required: false,
  ...
  @ApiProperty({
    required: false,
    type: () => MediaUpdateManyWithoutVoteEventCandidatesInput,
  })
  @ValidateNested()
  @Type(() => MediaUpdateManyWithoutVoteEventCandidatesInput)
  @IsOptional()
  @Field(() => MediaUpdateManyWithoutVoteEventCandidatesInput, {
    nullable: true,
  })
...
export { VoteEventCandidateUpdateInput as VoteEventCandidateUpdateInput };
