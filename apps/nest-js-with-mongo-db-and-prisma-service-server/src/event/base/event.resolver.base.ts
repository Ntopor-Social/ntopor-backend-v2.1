...
export class EventResolverBase {
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => [TicketPackage], { name: "ticketPackages" })
  @nestAccessControl.UseRoles({
  ...
  async findTicketPackages(
    ...
    const results = await this.service.findTicketPackages(parent.id, args);
  ...
  async getOrganizer(@graphql.Parent() parent: Event): Promise<User | null> {
